...
' 1) Series de tiempo estacionarias. Genere las siguientes series de tiempo (en un program en Eviews) de tal manera que todas sean estacionarias. Obtenga los gráficos, funciones de autocorrelación y funciones de autocorrelación parcial de cada serie de tiempo. Comente si estas funciones se asemejan a las funciones teóricas (las vistas en clase teórica).

' Definimos el tamaño y seteamos una raiz de pseudo números aleatorios para que los resultados sean replicables
